...
be different each time the rule is encountered.) For example, the rule 2: 1 3 |
3 1 means that to match rule 2, the text being checked must match rule 1
...
letters. This leaves eight possibilities:
